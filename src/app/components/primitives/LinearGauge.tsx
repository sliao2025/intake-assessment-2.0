 ...
 */
const getSigmundMessage = (score: number, isLoading?: boolean): string => {
  if (isLoading) {
    return "I am analyzing the emotional tone of your entry...";
  }
  if (score >= 70) {
    return "Your words are charged with positivity!";
  } else if (score >= 50) {
    return "There's a wonderful sense of balance in your writing.";
  } else if (score >= 30) {
    return "I detect a complex mix of feelings in your words.";
  } else {
    return "These reflections carry a weight of heavy emotions.";
  }
};
...
export default function LinearGauge({
  ...
  const message = getSigmundMessage(score, isLoading);
