    ...
    >
      ...
      >
        <motion.div
          ...
          className="w-full rounded-4xl border border-gray-200 bg-white/70 backdrop-blur-sm px-6 py-6 md:py-8 shadow-md md:max-h-[70vh] md:overflow-y-auto md:overflow-x-hidden md:overscroll-y-contain md:scrollable-div box-border"
          style={{
