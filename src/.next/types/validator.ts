...
// Validate ../../app/sessions/[id]/page.tsx
{
  ...
  handler satisfies AppPageConfig<"/sessions/[id]">
}

// Validate ../../app/api/cat/next-item/route.ts
{
  const handler = {} as typeof import("../../app/api/cat/next-item/route.js")
  handler satisfies RouteHandlerConfig<"/api/cat/next-item">
}
